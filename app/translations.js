export const translations = {
  en: {
    ...
    deals: {
      ...
      demandLabel: "Demand:",
      demandLow: "Low (Max Discount)",
      demandMedium: "Moderate",
      demandHigh: "High (Min Discount)",
      categories: {
        padel: "Padel",
        bowling: "Bowling",
        cinema: "Cinema",
    ...
    forBusiness: {
      ...
      title: "Fill your empty hours. Commission from just 5%.",
      subtitle: "Already offering off-peak promotions? We help more customers find them.",
      ...
      feature3Desc: "Risk-free at 10% per booking (form only), or subscription at €19.99/month with 5%, dynamic pricing and WhatsApp reservations. Free plan coming soon. No lock-in contracts.",
    ...
    modal: {
      ...
      successTitle: "Listing request sent!",
      successText: "Thank you for your interest. We will get in touch with you shortly to list your promotions.",
      closeBtn: "Close Window",
      bizName: "Business Name",
      bizNamePlac: "e.g. Lisbon Padel Club",
      contactName: "Contact Name",
      contactNamePlac: "Your full name",
      contactEmail: "Contact Email",
      contactEmailPlac: "name@business.com",
      ...
      activityTypes: {
        ...
        fitness: "Gym / Fitness",
        spa: "Spa / Wellness",
        other: "Other Leisure Experience"
      },
  ...
  pt: {
    ...
    hero: {
      ...
      ctaSecondary: "Registar o meu negócio",
      liveDealsPrefix: "",
    ...
    deals: {
      ...
      demandLabel: "Procura:",
      demandLow: "Baixa (Desc. Máximo)",
      demandMedium: "Moderada",
      demandHigh: "Elevada (Desc. Mínimo)",
      categories: {
        padel: "Padel",
        bowling: "Bowling",
        cinema: "Cinema",
    ...
    forBusiness: {
      label: "Para negócios",
      title: "Rentabilize as suas horas vazias. Comissão a partir de 5%.",
      subtitle: "Já oferece promoções fora de horas? Ajudamos a que mais clientes as encontrem.",
      ...
      feature3Title: "Planos flexíveis",
      feature3Desc: "Sem risco com 10% por reserva (formulário), ou subscrição a €19,99/mês com 5%, preços dinâmicos e reservas por WhatsApp. Plano grátis em breve. Sem contratos.",
    ...
    modal: {
      ...
      successText: "Obrigado pelo seu interesse. Entraremos em contacto muito em breve para configurar as suas promoções.",
      closeBtn: "Fechar Janela",
      bizName: "Nome do Negócio",
      bizNamePlac: "ex: Lisbon Padel Club",
      contactName: "Nome de Contacto",
      contactNamePlac: "O seu nome completo",
      contactEmail: "E-mail de Contacto",
      contactEmailPlac: "nome@empresa.com",
      ...
      activityTypes: {
        ...
        spa: "Spa / Bem-estar",
        other: "Outra Experiência de Lazer"
      },
